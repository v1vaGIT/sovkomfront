                    ...
                    <div className={s.rightContent__app}>
                        ...
                        <a className={s.app__link} href='#'>
                            ...
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M5.5415 3.20837H10.7915V8.45837" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3.36719 10.633L10.7918 3.20837" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </a>
                    </div>
                </div>
